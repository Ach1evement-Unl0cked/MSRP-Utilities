...
module.exports = class botCommand extends (
  ...
  constructor(client) {
    super(client, {
      name: "staffvote",
      group: "ia",
      memberName: "staffvote",
      guildOnly: true,
      description: "Make sure we have enough staff to start a session!",
      throttling: {
        usages: 1,
        duration: 120,
      },
  ...
  async run(message) {
    ...
    this.client.on("messageReactionAdd", async (reaction, user) => {
      if (reaction.message.id === sentMessage.id && reaction.emoji.id === customEmoji.id && !user.bot) {
        ...
        // Check if the number of votes reaches 5
        if (reactionCount >= 5) {
          ...
          await message.say({
            ...
            embed: {
              color: 4296191,
              title: "<:online:1225139255760781373> MSRP Staff Vote Complete",
              description: `We will now begin the public SSU vote in #sessions, go vote!`,
              thumbnail: {
              url: "https://cdn.discordapp.com/attachments/1224970670807711874/1225009092293296169/msrp.png?ex=662ac65f&is=662974df&hm=cf98bef97113de44844927b2da0f61b1f222a403ec5a369aaf766de3106fbee8&"
            },
            image: {
